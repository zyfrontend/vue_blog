...
class UploadServer {
  static async upload(ctx) {
    try {
      ...
      ctx.success("上传成功！", {
        // https://zyfullstack.top/article/79dd02bb4b1cc1c6cfdb0a2905e7e97940f631f7.%40150w_150h.jpg2022-02-18-16-57-32.jpg
        // http://zyfullstack.top/img/202202111808584.png
        url: `https://zyfullstack.top/${bucket}/${newName}`,
        createTime: +new Date(),
      });
