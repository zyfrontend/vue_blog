<template>
  <div class="about common">
    <Header :light-index="5" backgroundIndex="transparent"></Header>
    <Footer fixed></Footer>
...
export default {
  ...
  data() {
    return {
      info: {
        desc: "有4年前端开发经验，熟悉Vue、React、Angular前端框架。熟悉小程序开发（Taro、Remax、MpVue、Wepy、 云开发）。熟悉NodeJs、Koa，Egg等后端知识。具有良好的沟通能力、工作协调能力、不断学习新技术、熟练前端技术、热衷于前端开发。",
        imgs: [
          {
            _id: 1,
            imgUrl:
        ...
        tags: [
          { name: "Vue", color: randomColor() },
          { name: "React", color: randomColor() },
          { name: "Node", color: randomColor() },
        ],
      },
    };
  },
